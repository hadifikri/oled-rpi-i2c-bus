...
SSD1306.prototype.startScroll = function (dir, start, stop) {
  var scrollHeader, cmdSeq = [];
...
SSD1306.prototype.update = function () {
  ...
  this._waitUntilReady(function () {
    ...
    var displaySeq = [
      this.COLUMN_ADDR,
      this.screenConfig.coloffset, this.screenConfig.coloffset + this.WIDTH - 1, // column start and end address
      this.PAGE_ADDR,
      0, (this.HEIGHT / 8) - 1 // page start and end address
    ];
...
SSD1306.prototype.clearDisplay = function (sync) {
...
// buffer/ram test
SSD1306.prototype.drawPageSeg = function (page, seg, byte, sync) {
...
SSD1306.prototype.drawPixel = function (pixels, sync) {
...
SSD1306.prototype.drawLine = function (x0, y0, x1, y1, color, sync) {
...
SSD1306.prototype.fillRect = function (x, y, w, h, color, sync) {
  var immed = (typeof sync === 'undefined') ? true : sync;
...
SSD1306.prototype.writeString = function (font, size, string, color, wrap, sync) {
  var immed = (typeof sync === 'undefined') ? true : sync;
...
SSD1306.prototype.drawRGBAImage = function (image, dx, dy, sync) {
  var immed = (typeof sync === 'undefined') ? true : sync;
...
SSD1306.prototype.drawBitmap = function (pixels, sync) {
  let x;
  let y;
...
SSD1306.prototype._initialise = function () {
...
SSD1306.prototype._drawChar = function (byteArray, charHeight, size, _sync) {
  // take your positions...
...
SSD1306.prototype._readCharBytes = function (byteArray, charHeight) {
  var bitArr = [],
    bitCharArr = [];
...
SSD1306.prototype._findCharBuf = function (font, c) {
...
SSD1306.prototype._updateDirtyBytes = function (dirtyByteArray) {
